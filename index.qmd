---
title: "Influence of Dietary Patterns on BMI and there by on diseases"
execute:
  message: false
  warning: false
  echo: false
...
p <- ggplot(bmi_macros, aes(x = bmi_round, y = avg_percent, fill = macronutrient)) +
  ...
  labs(
    ...
    subtitle = "Higher BMI individuals have higher carb, high fat diets",
    x = "BMI",
    y = "Percent of Calories",
    fill = "Macronutrient",
    caption = "Source: Diet and nutritional status from 2011 [Global Dietary Database](https://globaldietarydatabase.org/management/microdata-surveys/653)"
  ) +
  theme_minimal() +
